...
import 'package:uniwayapp/widget/ProfessorValidat.dart';

class ProfessorValidiView extends StatelessWidget {
  const ProfessorValidiView({super.key});
