...
import 'package:uniwayapp/widget/StudentMangment.dart';

class StudentCondidatView extends StatelessWidget {
  const StudentCondidatView({super.key});
