...
class AdminService {
  Future<void> generateAndPrintPdf(
      AdminstratorsModele admin, String namesholarship) async {
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Table(
                ...
                children: [
                  _buildTableRow('First Name', admin.firstname),
                  _buildTableRow('Last Name', admin.lastname),
                  _buildTableRow('Level', admin.job),
                  _buildTableRow('Email', admin.email),
                  _buildTableRow('Specialty', admin.specialty),
                ],
              ),
