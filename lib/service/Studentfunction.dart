...
class StudentService {
  Future<void> generateAndPrintPdf(
      Studentmodel student, String namesholarship) async {
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Table(
                ...
                children: [
                  _buildTableRow('First Name', student.firstname),
                  _buildTableRow('Last Name', student.lastname),
                  _buildTableRow('Level', student.level),
                  _buildTableRow('Email', student.email),
                  _buildTableRow('Specialty', student.specialty),
                ],
              ),
