...
class AdminServiceList {
  Future<void> generateAndPrintPdf(List<AdminstratorsModele> students) async {
    final pdf = pw.Document();
    final imageData = await rootBundle.load('asset/image/logo7.png');
    final image = pw.MemoryImage(imageData.buffer.asUint8List());

    // Group students by status
    Map<String, List<AdminstratorsModele>> studentsByStatus = {
      'Accept': [],
      'Attend': [],
      'Reject': [],
    };
  ...
  pw.TableRow _buildTableRow(AdminstratorsModele student) {
    return pw.TableRow(
      children: [
        pw.Container(
          padding: const pw.EdgeInsets.all(8),
